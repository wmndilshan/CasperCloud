...
type InstanceStore interface {
	...
	UpdateTaskStatus(ctx context.Context, taskID uuid.UUID, status string, errMessage *string) error
	...
	GetInstanceByID(ctx context.Context, instanceID uuid.UUID) (*repository.Instance, error)
